...
(function($, window, document, undefined) {
	...
	bdsm.heroParalax = function() {
		console.log('heroParalax inited!');

		$(window).scroll(function(e) {
			e = e || window.event;
			let y = $(this).scrollTop();

			if (!detectmob()) { // if not mobile device
	...
	bdsm.desctopMenu = function() {
		console.log('desctopMenu inited!');
		...
		$('.page-nav__items-group ul')
			.mouseenter(function() {
				...
				if ($('.page-nav').hasClass('nav-interiors-init')) {
					...
					$('.nav-interiors').css({ 'transform': 'translateX(-13%)' });
	...
	bdsm.controlsAdaptive = function() {
		console.log('controlsAdaptive inited!');
		...
		$(window).resize(function() {
			...
			interiors.each(function(){
				...
				console.log('thsHeight', thsHeight);
   ...
   var curentRoomNumber = 0;
    ...
    var modalTinyNoFooter = new tingle.modal({
        ...
        beforeOpen: function() {
             modalTinyNoFooter.setContent(document.querySelector('.modal-form').innerHTML);
						$('.reservation .modal-form__room-number').val(curentRoomNumber)
						$('.reservation .modalform').attr('id', 'modalform');
    ...
    var btn = $('.js-modal');
       ...
       modalTitle.text('Book a session '+ curentRoomNumber );
...
$(document).ready(function() {
	...
	$('.rooms__control--right').click(function() {
		console.log(slidecounter, roomsLength);
	...
	$(window).bind('mousewheel', function(e) {
		...
		// if ($(this).scrollTop() === 0 && delta > 0 && !isAnimate){
		// 	gotoelement('#rooms', 1000, 0)
		// }



		// if (y >= getOffset('#conditions', 'top') - 10 && delta < 0 && !isAnimate ) {
		// 	if (checkChangeSection( $('#conditions'), 'up' ))
		// 		gotoelement('#portfolio', 1000, 0)
		// }
		// if (y >= getOffset('#portfolio', 'top') - 10 && y <= getOffset('#portfolio', 'top') + $('#portfolio').height()-10 && delta > 0 && !isAnimate  && checkChangeSection( $('#portfolio'), 'down' )) {
		// 	gotoelement('#conditions', 1000, 0)
		// }
		// if (y >= getOffset('#portfolio', 'top') - 10 && delta < 0 && !isAnimate) {
		// 	if (checkChangeSection( $('#portfolio'), 'up' ))
		// 		gotoelement('#rooms', 1000, 0)
		// }
...
function scrollToPrevious() {
	...
	console.log('scrollToPrevious', currentSection, 'Previous' , prevElement);
...
function scrollToNext() {
	...
	console.log('scrollToNext', currentSection, 'Next' , nextElement);
